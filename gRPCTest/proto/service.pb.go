...
func (m *Responce) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Responce.Merge(m, src)
}
...
func (m *Responce) GetResult() int64 {
	if m != nil {
		return m.Result
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Responce)(nil), "proto.Responce")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xc5, 0x11, 0x94, 0x5a, 0x5c, 0x90, 0x9f, 0x97, 0x9c, 0x2a, 0x24, 0xc6, 0xc5, 0x56, 0x94, 0x5a,
	...
	0x49, 0x50, 0x71, 0x12, 0x1b, 0x98, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x7b, 0xeb, 0xc0,
	0xaf, 0xcc, 0x00, 0x00, 0x00,
}
...
type AddServiceClient interface {
	Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Responce, error)
	Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Responce, error)
}
...
func (c *addServiceClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Responce, error) {
	out := new(Responce)
...
func (c *addServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Responce, error) {
	out := new(Responce)
...
type AddServiceServer interface {
	Add(context.Context, *Request) (*Responce, error)
	Multiply(context.Context, *Request) (*Responce, error)
}
...
func (*UnimplementedAddServiceServer) Add(ctx context.Context, req *Request) (*Responce, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (*UnimplementedAddServiceServer) Multiply(ctx context.Context, req *Request) (*Responce, error) {
