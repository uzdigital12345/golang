...
func (s *Sqlx) GetContact(i int64) (*pt.Contact, error) {

	getContactQuery := " select * from users where id = $1"

	var contact *pt.Contact

	err := s.db.Select(&contact, getContactQuery, i)
